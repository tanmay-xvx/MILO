"""
LIAL Device Registry — manages multiple connected LIAL receivers.
...
from lial_device import DeviceStatus, ExecResult, LialDevice
from transport import LialTransport, SerialTransport, TcpTransport


@dataclass
class RegisteredDevice:
    """A device registered in the LIAL device registry."""
...
class DeviceRegistry:
    """Registry for managing multiple LIAL receivers.
    ...
    def register(self, name: str, transport: LialTransport, tags: list[str] | None = None) -> RegisteredDevice:
        """Register a new device with the given transport."""
        device = LialDevice(transport, name=name)
