"""
MILO Board Registry -- Maps USB VID/PID pairs to board families.
...
class DetectedDevice:
    ...
    milo_version: str | None = None  # None = no MILO firmware detected

    @property
    def has_milo(self) -> bool:
        return self.milo_version is not None

    @property
    def is_blank(self) -> bool:
        """No MILO firmware but we recognised the hardware family."""
        return self.milo_version is None and self.confirmed_family is not None
